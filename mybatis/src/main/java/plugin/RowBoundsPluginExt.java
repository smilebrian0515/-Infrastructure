 ...
 * @author Jeff Butler
 */
public class RowBoundsPluginExt extends PluginAdapter {
    ...
    public boolean clientBasicSelectManyMethodGenerated(Method method, Interface interfaze,
        ...
        addNewComposedFunctionLimitAndOffset(interfaze, introspectedTable, method.getReturnType());
    ...
    private void addNewComposedFunctionLimitAndOffset(Interface interfaze, IntrospectedTable introspectedTable, FullyQualifiedJavaType baseMethodReturnType) {
//        interfaze.addImportedType(new FullyQualifiedJavaType("java.util.function.Function")); //$NON-NLS-1$
        interfaze.addImportedType(new FullyQualifiedJavaType("org.brian.dao.ext.paging.LimitAndOffsetAdapter")); //$NON-NLS-1$

        String tableFieldName =
                JavaBeansUtil.getValidPropertyName(introspectedTable.getFullyQualifiedTable().getDomainObjectName());

        FullyQualifiedJavaType returnType = new FullyQualifiedJavaType("QueryExpressionDSL<LimitAndOffsetAdapter<" //$NON-NLS-1$
                + baseMethodReturnType.getShortName() + ">>"); //$NON-NLS-1$


        Method method = new Method("selectWithLimitAndOffset"); //$NON-NLS-1$
        method.setDefault(true);
        method.setReturnType(returnType);
        ...
        method.addBodyLine("return SelectDSL.select(selectModel -> LimitAndOffsetAdapter.of(selectModel, this::selectMany, limit, offset), "); //$NON-NLS-1$
